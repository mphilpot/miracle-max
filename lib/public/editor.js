  ...
  $('#file_upload').fileupload({
    ...
    dropZone: $('#file_upload'),
      ...
      if(data.result.error) {
        $rootScope.$broadcast('error', 'error uploading your avatar');
      } else {
        $rootScope.$broadcast('success', 'You uploaded image ' + data.result.path);
      }
      $scope.$apply();
    }
  });
...
var miracleMax = angular.module('miracleMax', []);
